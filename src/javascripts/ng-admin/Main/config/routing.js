...
function routing($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider.state('ng-admin-login', {
    abstract: true,
    views: {
      'ng-admin-login': {
        controller: 'AppController',
  ...
  $stateProvider.state('dashboard', {
    ...
    resolve: {
      ...
      responses: [
        ...
        'Entry',
        'ReadQueries',
        function($stateParams, $q, collections, dataStore, Entry, ReadQueries) {
          var sortField = 'sortField' in $stateParams
          ...
          for (collectionName in collections) {
            ...
            promises[collectionName] = (function(
              collection,
              collectionSortField,
              collectionSortDir
            ) {
              ...
              return ReadQueries.getAll(
                ...
                .then(rawEntries =>
                  ReadQueries.getReferenceData(collection.fields(), rawEntries))
                .then(referenceData => {
                ...
                .then(() => {
                  ...
                  dataStore.fillReferencesValuesFromCollection(
                    entries,
      ...
      entries: [
        'responses',
        'collections',
        function(responses, collections) {
          var collectionName, entries = {};

          for (collectionName in responses) {
            entries[collections[collectionName].name()] = responses[
              collectionName
            ];
          }
